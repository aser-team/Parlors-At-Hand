...
public class SearchParlorListJFrame extends javax.swing.JFrame {
     ...
     */
    public SearchParlorListJFrame(Object st) {
        initComponents();
       //jLabel1.setText(st);
       parlorList.add(this, st);
    }

    private SearchParlorListJFrame() {
    ...
    private void initComponents() {
        ...
        parlorList = new javax.swing.JList<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("jLabel1");

        parlorList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(parlorList);
    ...
    private javax.swing.JList<String> parlorList;
